...
const spinner_video = () => {
  ...
  return (
      ...
      {Database.Video_iframe.slice(Database.Video_iframe.length - 3).map((Videos) => (
        <div className="Video_news_img_div_flex" onClick={openModal_video} key={Videos.id}>
          ...
          <span className="Video_news_img_div_p_sopl">
            <div className="Video_news_img_div_p">
              <p className="Hot_topics_news_images_date"><BiTimeFive/>Ngày {Videos.Date_video}</p>
              <span className="Video_news_img_div_p_sopl_s">19:10</span>
            </div>
