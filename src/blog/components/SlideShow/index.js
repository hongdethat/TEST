...
// import Read_news from '../../../Read_news/Container/HomepageNewsBogs';
...
export default class Slideshow extends React.Component {
  ...
  getNewSlideIndex = step => {
    ...
    const numberSlide = Database.user.length_step;
    ...
    return (
      <div className="lp-slideshow">
        <div className="container">
          ...
          {Database.user.map((HomepageNewsBogs, index) => {
            const Background = {backgroundImage: 'url(' + HomepageNewsBogs.link_images + ')', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', width: '100%', height: '100%', cursor: 'auto'}
            return (
              <div
                key={index}
                className={`slide ${
              ...
              >
                <div style={Background} className="index_sliderflexrow">
                  ...
                  <span className="index_padding">
                    <div className="index_sliderflex">
                      ...
                      <div className="number-text">
                        {`${index + 1} / ${Database.user.length_step = 3}`}
                      </div>
                    ...
                    <div className="text_index">
                      <div className="Home_page_news_row_index">
                        ...
                        <Link
                          to={`/Blogs/${HomepageNewsBogs.danh_muc_link}/`}
                          ><p className="Index_coloru">Tin {HomepageNewsBogs.danh_muc}</p>
                        </Link>
                      </div>
                      <Link
                      to={`/Blogs/${HomepageNewsBogs.danh_muc_link}/${HomepageNewsBogs.link_page}/`}
                          ><h1 className="text_index_h1">{HomepageNewsBogs.title}</h1>
                      </Link>
                      <h4 className="text_index_h4">27 phút trước
                      <Link
                      to={`/Blogs/${HomepageNewsBogs.danh_muc_link}/${HomepageNewsBogs.link_page}/`}
                          ><p className="Home_page_news_row2 zindex-index">Xem<HiArrowSmRight className="index_sliderflexrow_icons"/></p>
                      </Link>
                      </h4>
                    </div>
                  </span>
                  ...
                  <div className="caption-text">
                    ...
                    <span className="text_index_p2">{parse(HomepageNewsBogs.content)}</span>
                    <Link
                      to={`/Blogs/${HomepageNewsBogs.danh_muc_link}/${HomepageNewsBogs.link_page}/`}
