...
const [selectedNhom, setSelectedNhom] = useState(undefined);
  ...
  return (
    <>
      <title>Tin tức - Bài đăng | WORLD SINGULARITY</title>
      ...
      <form onSubmit={(e)=> submit(e)} className="NewsAdminstration__Padding__2rem">
        ...
        <div className="Administrator_admin_from_span_button1_Editor_a_grid">
                    ...
                    <a onClick={isOpenActions4.toggle} className="Administrator_admin_from_span_button1_Editor_a">{isOpen4 ? 
                     ...
                     {isOpen4 ? <div className="Administrator_admin_hashtag_checkbox_div Admin_animation">
                                  ...
                                  <textarea readOnly 
                                            ...
                                            ref={refResult} 
                                            onChange={(e)=> handle(e)} 
                                            value={"http://localhost:3000/Blogs/" + parseStringDataLayer(selected ? selected.danhmuc : "Chưa chọn danh mục") + "/" + Date_show + "-" + parseStringDataLayer(data.title)} 
                                            id="link_page" 
                                  ...
                                  {isOpen7 || isOpen8 ? (
                                    <div className="Administrator_admin_hashtag_p_output_test_div">
                                      ...
                                      {isOpen8 && 
                                        <span>
                                          <input readOnly placeholder="http://localhost:3030/Blogs/..." type="text" ref={refResult} onChange={(e)=> handle(e)} value={parseStringDataLayer(data.title)} id="link_page"/>
                                        </span>
                                      }
                                    </div>
                                  ) : (
                                 ...
                                 <input  onChange={(e)=> handle(e)} placeholder="Thêm liên kết hình ảnh" type="text" className="Header_input" id="link_images" value={data.link_images}/>

                                 <p className="Administrator_admin_hashtag_LK_TD">Tiêu đề ảnh <RiQuestionMark className="Administrator_admin_hashtag_icons"/></p>
                                 <input  onChange={(e)=> handle(e)} placeholder="Nhập tiêu đề ảnh" type="text" className="Header_input" id="title_img" value={data.title_img}/>
                      ...
                      <a onClick={isOpenActions5.toggle} className="Administrator_admin_from_span_button1_Editor_a">{isOpen5 ? 
                       ...
                       {isOpen5 ? <div className="Admin_animation">
                                    <input onChange={(e)=> handle(e)} id="De_xuat" value={data.De_xuat} placeholder="Nhập mô tả tìm kiếm" type="text" className="Header_input impotant__ADMIN_NEWS"/>
                                  </div>
                        : null}
        ...
        <div className="Administrator_admin_from_fl_flex_form">
              <div className="Administrator_admin_from_fl_flex_width">
                ...
                <a onClick={isOpenActions10.toggle} className="Administrator_admin_from_span_button1_Editor_a">{isOpen10 ? 
                 ...
                 {isOpen10 ? <div className="Admin_animation">
                              <input onChange={(e)=> handle(e)} value={selected ? selected.danhmuc : "Chưa chọn danh mục"}  placeholder="Danh mục" type="text" className="Header_input impotant__ADMIN_NEWS" required="required" maxLength={20} minLength={5}/>
                              <div className="Administrator_admin_hashtag_p">
                                {items.map((item, i) => (
                                    <DANHMUC
                                      key={item.id}
                   ...
                   : null}
                    ...
                    <a onClick={isOpenActions4.toggle} className="Administrator_admin_from_span_button1_Editor_a">{isOpen4 ? 
                     ...
                     {isOpen4 ? <div className="Administrator_admin_hashtag_checkbox_div Admin_animation">
                                 ...
                                 <p className="Administrator_admin_hashtag_LK_TD">Liên kết tiêu đề <RiQuestionMark className="Administrator_admin_hashtag_icons"/></p>
                                 <input placeholder="Thêm liên kết tiêu đề" type="text" className="Header_input impotant__ADMIN_NEWS"/>

                                 <p className="Administrator_admin_hashtag_LK_TD">Liên kết Hình ảnh (Thủ công)<RiQuestionMark className="Administrator_admin_hashtag_icons"/></p>
                                 <input  onChange={(e)=> handle(e)} placeholder="Thêm liên kết hình ảnh" type="text" className="Header_input impotant__ADMIN_NEWS" id="link_images" value={data.link_images}/>

                                 <p className="Administrator_admin_hashtag_LK_TD">Tiêu đề ảnh <RiQuestionMark className="Administrator_admin_hashtag_icons"/></p>
                                 <input  onChange={(e)=> handle(e)} placeholder="Nhập tiêu đề ảnh" type="text" className="Header_input impotant__ADMIN_NEWS" id="title_img" value={data.title_img}/>
                                 <p className="Administrator_admin_hashtag_LK_TD Administrator_admin_hashtag_LK_TD_2">Thêm liên kết đính kèm khác</p>
                                </div>
                       : null}
...
export default NewsAdminstration;