...
import useModal from './manage-account/Modal/useModal';
...
import AdminList from './manage-account/AdminList';
import AddModal from './manage-account/AddModal';

import Search from './manage-account/Search';
...
//Đếm dữ liệu
const DemData = JSON.parse(JSON.stringify(Database.Dashboards)).length;
              ...
              <div className="AdminAccount_css_fl_ax AD1">
                ...
                <div className="AdminAccount_css_sk_all_flex">
                  <div className="AdminAccount_css_sk_all_flexdds_scrolling">
                    {Database.user.filter(filterNames).map((search, title) => {
                      return  (
