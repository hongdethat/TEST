  ...
  return (
      ...
      <div className="gpt3__navbar-menu">
        {toggleMenu_reponsive
          ? <VscClose color="#fff" size={27} onClick={() => setToggleMenu_reponsive(false)} />
          : <BsChevronExpand color="#fff" size={27} onClick={() => setToggleMenu_reponsive(true)} />}
        {toggleMenu_reponsive && (
        <div className="gpt3__navbar-menu_container animation_extra Mobile_header_color_hover">
