...
import { Solar, saotho, metaverse } from '../../images/images';
import React, { useState } from "react";
import ReactDOM from "react-dom";
import { Tabs, Tab, Content} from "./functions/tab/Planet";
        ...
        <div className="gpt3__possibility-content Section_planet_right PLN2">
          ...
          <div className="gpt3__possibility-content">
            <div className="Section_planet_test">
              ...
              <h4 className="Section_planet_content">{t('Truy cập vào trạm vũ trụ ngay hôm nay')}<HiOutlineArrowSmRight className="FAcolors"/></h4>
          </div>
            ...
            <Content active={active === 0}>
              <h1 className="Section_planet_color">
                <div className="gpt3__features-container__feature-title">
                  ...
                  <div></div>
                  <h4 className="Section_planet_h4">{t('Xem kết quả')} <HiOutlineArrowSmRight className="FAcolors" data-tip data-for="locate_one"/></h4>
                </div>
              </h1>
            </Content>
            <Content active={active === 1}>
              <h1 className="Section_planet_color">
                <div className="gpt3__features-container__feature-title">
                  ...
                  <div></div>
                  <h4 className="Section_planet_h4">{t('Đặt chân lên vũ trụ')}<HiOutlineArrowSmRight className="FAcolors" data-tip data-for="locate_two"/></h4>
                </div>
              </h1>
            </Content>
            <Content active={active === 3}>
              <h1 className="Section_planet_color">
                <div className="gpt3__features-container__feature-title">
                  ...
                  <div></div>
                  <h4 className="Section_planet_h4">{t('Bắt đầu khám phá các hành tinh')}<HiOutlineArrowSmRight className="FAcolors" data-tip data-for="locate_three" data-event="click"/></h4>
                </div>
              </h1>
            </Content>
          </div>
