...
import { Data_icon } from '../Data/Dataplanet';

import './Element_planet.css'; 

const ElementPlanet = function(props) {
...
function changeBackground(id) {
  ...
  return (
    ...
    {Data_icon.map(({ id, name, image, link, cai_dat, id_click, cai_dat_two, content, icons }) => (
    <div key={id}>
          ...
          <div className="dsdsakfm">
            ...
            <div className="sndoasjds">
              <a href={link} id={id_click}>
                <img src={require(`../../../../images/picture/Planet/${image}`)} id={id_click} className={cai_dat_two}  alt={t('alt_img') + "'" + t(name) + "'"}/>
              </a>
            </div>
