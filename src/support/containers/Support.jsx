...
import NewsSupport from '../components/NewsSupport';

// import Avatar from '../../Image/Avatar.png';
import { AI, assistant, record } from '../../images/images';
// import Avatars from '../../Image/User/none.png';
import { background } from '../../video/video';
...
return (
    <div className="Assistant_background App">
      ...
      <div className="Assistant_background_logo">
        <div className="Assistant_background_question_paddingdsmflecx">
          ...
          <a href="/Support/"><p>Trung tâm hỗ trợ</p></a>
        </div>
      ...
      <div className="path_assistant">
        ...
        <div className="Assistant_flex_pd">
          ...
          <span className="Assistant_span_bacckground_sp_flopa">
            <BsMic className="Assistant_flex_pd_Assistant"/>
          {/*  <Modal
              isShowing={isShowing}
              hide={toggle}
            />*/}
